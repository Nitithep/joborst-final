...
try {
	...
	$compid = $row['company'];
	if ($jobtype == "ปิดรับสมัคร") {
	$sta = '<span class="label label-danger">ปิดรับสมัคร</span>';
											  
	}
	if ($jobtype == "เปิดรับสมัคร") {
	$sta = '<span class="label label-success">เปิดรับสมัคร</span>';
...
<head>
	...
	<title>JOB ORST - <?php echo "$jobtitle"; ?></title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
						<a href="./"><img src="images/orstlogo.png" alt="Logo" /></a>
						</div>
					</div>
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-header text-center">
									...
									<h2 class="heading mb-15"><?php echo "$jobcategory"; ?></h2>
									
									
									<ul class="meta-list clearfix">
										<li>
											<h4 class="heading">ระยะเวลาการจ้างงาน:</h4>
											<?php echo "$jobcountry"; ?>
										</li>
										<li>
										...
										<li>
											<h4 class="heading">วันที่ลงประกาศ: </h4>
											<?php echo "$opendate"; ?>
										</li>
									</ul>
								...
								<div class="job-detail-content mt-30 clearfix">
									...
									<h3><b>คุณสมบัติเฉพาะตำแหน่ง</b></h3>

									<p><?php echo "$jobdescription"; ?></p>

									
									<h3><b>หน้าที่ความรับผิดชอบ<b></h3>
									
                                    <p><?php echo "$jobrespo"; ?></p>
									
									<h3><b>เอกสารการสมัคร/สถานที่รับสมัครงาน:</b></h3>
                                    <p><?php echo "$jobreq"; ?></p>
