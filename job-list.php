					...
					<div class="result-wrapper">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-25">
                                ...
                                $post_month = date_format(date_create_from_format('d/m/Y', $row['closing_date']), 'm');
								...
								if ($type == "ปิดรับสมัคร") {
								$sta = '<span class="job-label label label-danger">ปิดรับสมัคร</span>';
											  
								}
								if ($type == "เปิดรับสมัคร") {
								$sta = '<span class="job-label label label-success">เปิดรับสมัคร</span>';
